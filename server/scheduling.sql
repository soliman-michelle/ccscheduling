...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2024 at 12:55 PM
...
INSERT INTO `summer_sched` (`summer_id`, `id`, `block`, `type`, `start_time`, `end_time`, `room`) VALUES
(20, 17, 'A', 'ftf', 0, 0, 0),
(21, 17, 'A', 'online', 0, 0, 0),
(22, 17, 'A', 'lab', 0, 0, 0),
(23, 18, 'A', 'ftf', 0, 0, 0),
(24, 18, 'A', 'online', 0, 0, 0),
(25, 19, 'A', 'ftf', 0, 0, 0),
(26, 19, 'A', 'online', 0, 0, 0),
(27, 19, 'B', 'ftf', 0, 0, 0),
(28, 19, 'B', 'online', 0, 0, 0);
...
(41, 'mcjosh', '$2b$10$w0KqZXz6/OtMoRE8cG9cz.WeAHnN/wb1YvDz761BFPzbgCADOyiG2'),
...
--
ALTER TABLE `summer_sched`
  MODIFY `summer_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
